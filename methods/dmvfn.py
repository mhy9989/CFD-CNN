...
from models import DMVFN_Model
from utils import reduce_tensor, LapLoss, VGGPerceptualLoss, ProgressBar, gather_tensors_batch
        ...
        for batch_x, batch_y in train_pbar:
            ...
            with self.amp_autocast():
                ...
                for i in range(n - 2): # Calculate gradients for each time step
                    ...
                    pred_y, loss_G = self.predict(x, gt)
                    loss_avg += loss_G
