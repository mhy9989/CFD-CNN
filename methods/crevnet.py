...
class CrevNet(Base_method):
    ...
    def __init__(self, args, device, steps_per_epoch):
        args.data_previous = args.data_previous - 2
    ...
    def _init_optimizer(self, steps_per_epoch):
        self.optimizer, self.scheduler, self.by_epoch_1 = get_optim_scheduler(
            self.args, self.args.epoch, self.model.framepredictor, steps_per_epoch)
        self.optimizer2, self.scheduler2, self.by_epoch_2 = get_optim_scheduler(
